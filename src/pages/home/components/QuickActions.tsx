...
const actions: Action[] = [
  ...
  { label: 'Receive Stock',     icon: 'ri-inbox-archive-line',     iconBg: 'from-teal-50 to-teal-100/60',    iconColor: 'text-teal-600',    desc: 'Log stock that just arrived',   path: '/stock-receives?action=new' },
