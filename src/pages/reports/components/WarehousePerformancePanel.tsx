...
import type { WarehousePerf, VendorPerf } from '../page';

interface WarehousePerformancePanelProps {
...
export default function WarehousePerformancePanel({ warehouses: warehouseData, vendors: vendorData, loading }: WarehousePerformancePanelProps) {
  ...
  const maxRevenue = vendorData.length > 0 ? Math.max(...vendorData.map((v) => v.revenue), 1) : 1;
    ...
    <div className="space-y-5">
      ...
      <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-5">
        ...
        {warehouseData.length === 0 ? (
          <div className="flex items-center justify-center py-10 text-gray-400 text-sm">No warehouses in scope</div>
        ) : (
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2.5">
                    <div className="w-9 h-9 rounded-xl flex items-center justify-center bg-emerald-100">
                      <i className="ri-building-2-line text-base text-emerald-600"></i>
                    </div>
                    <div>
      ...
      <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-5">
        ...
        {vendorData.length === 0 ? (
          <div className="flex items-center justify-center py-10 text-gray-400 text-sm">No purchases from vendors this period</div>
        ) : (
